  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        xp: "border-transparent bg-[#FFC800] text-black shadow",
        streak: "border-transparent bg-[#FF9600] text-white shadow",
        progress: "border-transparent bg-[#CE82FF] text-white shadow",
      },
    },
    defaultVariants: {
      variant: "default",
